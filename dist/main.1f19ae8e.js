...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"normwheel.js":[function(require,module,exports) {
/**
...
exports.default = exports._gsScope = exports.TweenPlugin = exports.TweenLite = exports.SimpleTimeline = exports.Power4 = exports.Power3 = exports.Power2 = exports.Power1 = exports.Power0 = exports.Linear = exports.EventDispatcher = exports.Ease = exports.Animation = void 0;
/*!
 * VERSION: 2.0.1
 * DATE: 2018-05-30
 ...
 */
const _gsScope = typeof window !== "undefined" ? window : typeof module !== "undefined" && module.exports && typeof global !== "undefined" ? global : void 0 || {};
...
const TimelineLite = _TweenLite._gsScope.TimelineLite;
...
const TimelineMax = _TweenLite._gsScope.TimelineMax;
...
const TweenMax = _TweenLite._gsScope.TweenMax;
...
const CSSPlugin = _TweenLite._gsScope.CSSPlugin;
...
const AttrPlugin = _TweenLite._gsScope._gsDefine.plugin({
  propName: "attr",
  API: 2,
  version: "0.6.1",
...
const RoundPropsPlugin = _TweenLite._gsScope._gsDefine.plugin({
    propName: "roundProps",
    version: "1.7.0",
    priority: -1,
    API: 2,
...
const DirectionalRotationPlugin = _TweenLite._gsScope._gsDefine.plugin({
...
const Back = _TweenLite._gsScope.Back;
exports.Back = Back;
const Elastic = _TweenLite._gsScope.Elastic;
exports.Elastic = Elastic;
const Bounce = _TweenLite._gsScope.Bounce;
exports.Bounce = Bounce;
const RoughEase = _TweenLite._gsScope.RoughEase;
exports.RoughEase = RoughEase;
const SlowMo = _TweenLite._gsScope.SlowMo;
exports.SlowMo = SlowMo;
const SteppedEase = _TweenLite._gsScope.SteppedEase;
exports.SteppedEase = SteppedEase;
const Circ = _TweenLite._gsScope.Circ;
exports.Circ = Circ;
const Expo = _TweenLite._gsScope.Expo;
exports.Expo = Expo;
const Sine = _TweenLite._gsScope.Sine;
exports.Sine = Sine;
const ExpoScaleEase = _TweenLite._gsScope.ExpoScaleEase;
...
const TweenMax = _TweenMaxBase.default;
exports.default = exports.TweenMax = TweenMax;
...
var top = (windowHeight - liheight) / 2;
var factor = windowHeight / liheight;
var maxScroll = ($('.main-scroller').height() - windowHeight) / factor;
var isScrolling = false;
var clip = 'rect(' + top + 'px, ' + windowWidth + 'px, ' + (top + liheight) + 'px, 0)';
$('.nav ul').css('top', top);
$('.nav__2').css('clip', clip);
function Velocity(e) {
  if (isScrolling) {
    var speed = (currentS - lastS) / (e - lastTime);
    if (speed < -5) speed = -5;
    if (speed > 5) speed = 5;
    _gsap.TweenLite.to('.nav', 2, {
      skewY: speed * 30
    });
    lastTime = e;
    lastS = currentS;
...
function gotoClosest() {
  var closest = Math.round(factor * currentS / windowHeight);
  goto(closest);
}
function goto(n) {
  currentS = liheight * n;
  _gsap.TweenLite.to('.main-scroller', 1, {
    y: -liheight * n * factor,
    overflow: 5,
...
document.addEventListener('wheel', function (event) {
  ...
  var norm = (0, _normwheel.default)(event);
  currentS += norm.spinY * 10;
  if (currentS < 0) currentS = 0;
  if (currentS > maxScroll) currentS = maxScroll;
  _gsap.TweenLite.to('.main-scroller', 0.5, {
    y: -currentS * factor,
    overflow: 5,
    onUpdate: function onUpdate() {
      _gsap.TweenLite.set('.nav ul', {
        y: -currentS
      });
    },
    onComplete: function onComplete() {
...
},{"./normwheel":"normwheel.js","gsap":"node_modules/gsap/index.js"}],"../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
